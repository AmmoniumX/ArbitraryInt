...
using Int128 = ArbitraryPrecision::FixedInteger<128>;
using Int256 = ArbitraryPrecision::FixedInteger<256>;
using Int512 = ArbitraryPrecision::FixedInteger<512>;
...
TEST_SUITE("String Conversion") {
  ...
  TEST_CASE("from_string with valid input") {
    CHECK(ArbitraryPrecision::from_string<Int128>("0").value() == Int128(0));
    CHECK(ArbitraryPrecision::from_string<Int128>("1").value() == Int128(1));
    CHECK(ArbitraryPrecision::from_string<Int128>("42").value() == Int128(42));
    CHECK(ArbitraryPrecision::from_string<Int128>("123").value() ==
          Int128(123));
    CHECK(ArbitraryPrecision::from_string<Int128>("12345").value() ==
          Int128(12345));
  }

  TEST_CASE("from_string with large numbers") {
    CHECK(ArbitraryPrecision::from_string<Int128>("1000000").value() ==
          Int128(1000000));
    CHECK(ArbitraryPrecision::from_string<Int128>("18446744073709551615")
              .value() == Int128(UINT64_MAX));
  }

  TEST_CASE("from_string with leading zeros") {
    CHECK(ArbitraryPrecision::from_string<Int128>("00042").value() ==
          Int128(42));
    CHECK(ArbitraryPrecision::from_string<Int128>("0000").value() == Int128(0));
  }

  TEST_CASE("to_string and from_string roundtrip") {
    Int128 original(12345);
    std::string str = ArbitraryPrecision::to_string(original);
    Int128 parsed = ArbitraryPrecision::from_string<Int128>(str).value();
  ...
  TEST_CASE("to_string and from_string with different bit sizes") {
    ...
    Int256 parsed256 = ArbitraryPrecision::from_string<Int256>(str256).value();
    CHECK(parsed256 == val256);

    Int512 val512(987654321);
    std::string str512 = ArbitraryPrecision::to_string(val512);
    Int512 parsed512 = ArbitraryPrecision::from_string<Int512>(str512).value();
  ...
  TEST_CASE("from_string with very large multi-segment value") {
    ...
    Int256 parsed = ArbitraryPrecision::from_string<Int256>(large_str).value();
...
using Dynamic = ArbitraryPrecision::DynamicInteger;
...
TEST_SUITE("Dynamic Integer - String Conversion") {
  ...
  TEST_CASE("from_string with valid input") {
    CHECK(ArbitraryPrecision::from_string<Dynamic>("0").value() == Dynamic(0));
    CHECK(ArbitraryPrecision::from_string<Dynamic>("42").value() ==
          Dynamic(42));
    CHECK(ArbitraryPrecision::from_string<Dynamic>("12345").value() ==
          Dynamic(12345));
  }

  TEST_CASE("from_string with large value") {
    CHECK(ArbitraryPrecision::from_string<Dynamic>("18446744073709551615")
  ...
  TEST_CASE("to_string and from_string roundtrip") {
    ...
    std::string str = ArbitraryPrecision::to_string(original);
    Dynamic parsed = ArbitraryPrecision::from_string<Dynamic>(str).value();
    CHECK(parsed == original);
  }
...
TEST_SUITE("Dynamic Integer - Comparison with FixedInteger") {
  TEST_CASE("Dynamic and FixedInteger produce same results for small values") {
    Dynamic dyn_a(12345);
    Dynamic dyn_b(67890);
  ...
  TEST_CASE("Dynamic can exceed FixedInteger size") {
    Dynamic dyn(1);
    ...
    // A 128-bit FixedInteger would wrap, but Dynamic grows
